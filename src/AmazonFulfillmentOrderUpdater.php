...
/**
 * Submits a request to update a fulfillment order in Amazon.
 *
 * This Amazon Outbound Core object can submit a request to Amazon to
 * update Fulfillment Order. In order to update an order,
 * a Shipment ID is needed. Shipment IDs are given by Amazon by
 * using the <i>AmazonFulfillmentPreview</i> object.
 */
class AmazonFulfillmentOrderUpdater extends AmazonOutboundCore
{

  /**
   * AmazonFulfillmentOrderUpdater updated a fulfillment order. You need a fulfillment order ID.
   *
   ...
   * This parameter is required for updating a fulfillment order with Amazon.
   ...
   *
   * Submits a <i>UpdateFulfillmentOrder</i> request to Amazon. In order to do this,
