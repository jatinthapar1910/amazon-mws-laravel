...
interface Enum
{
  ...
  const INBOUND_INTENDED_BOX_CONTENTS_SOURCES           = [
    self::INBOUND_INTENDED_BOX_CONTENTS_SOURCE_NONE,
    self::INBOUND_INTENDED_BOX_CONTENTS_SOURCE_FEED,
    self::INBOUND_INTENDED_BOX_CONTENTS_SOURCE_2D_BARCODE,
  ];
